    ...
    <div className='bg-black font-geist-mono text-[#f4f4f4] w-full'>
        <Navbar />
          <div className='w-full h-[20em] flex justify-center pt-40'>
            <h1 className='text-[2em] font-extrabold' data-aos="fade-up">Dev<span className='bg-red-600'>eloper</span></h1>
          </div>
      ...
      <div className='w-full flex justify-center pt-40'>
        <h1 className='text-[2em] font-extrabold' data-aos="fade-up">Lap<span className='bg-red-600'>oran</span></h1>
      </div>
      ...
      <div className='w-full mt-16 flex justify-center bg-white py-16'>
        <div className='text-center max-w-3xl px-8'>
          <h2 className='text-[1.8em] font-extrabold text-black' data-aos="fade-up">Tentang Website</h2>
          <p className='text-lg leading-8 mt-4 text-gray-700' data-aos="fade-up">
          ...
          <p className='text-xl font-bold mt-6 italic text-red-600' data-aos="fade-up">
